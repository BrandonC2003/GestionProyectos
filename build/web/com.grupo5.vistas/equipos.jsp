<%-- 
    Document   : equipos
    Created on : 5 sep. 2023, 09:25:10
    Author     : brand
--%>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="col-md-offset-1 col-md-10">
				<h1 class="text-center">Mi Espacio de Trabajo</h1>
				<br /> <br />

				<div class="panel panel-info">
					<div class="panel-heading">
						<div class="panel-title">Listado de Usuarios por Proyecto</div>
					</div>
					<div class="panel-body">
						...
						<br /> <br /> <a href="agregar" class="btn btn-success"><i
							class="glyphicon glyphicon-check"></i> Agregar Integrante</a>
					</div>
				</div>
			</div>
		</div>
