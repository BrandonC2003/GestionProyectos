<%-- 
    ...
    Created on : 5 sep. 2023, 09:30:10
    Author     : brand
--%>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Ingrese su Email para enviar un link y recuperrar
                                            su contraseña!</p>
                                    </div>
                                    <form class="user">
                                        ...
                                        <a href="http://localhost:8080/GestionProyectos/com.grupo5.vistas/opcionesRegistro/reestablecerClave.jsp" class="btn btn-primary btn-user btn-block">
                                            Enviar correo
                                        </a>
                                    </form>
                                    <hr>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="http://localhost:8080/GestionProyectos/">Si ya tiene cuenta Iniciar aqui!</a>
