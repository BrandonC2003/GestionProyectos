        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <!--Informacion que se mostrara con la ayuda de nuestra 
                                                base de datos--></div>
                    ...
                    <div class="Avances">
                        <h2 id="avance" class="text-danger">Avances</h2>
                        <div style="width: 400px; height: 400px;">
                            <!-- Agregar un lienzo (canvas) para el gráfico -->
                            <canvas id="miGraficoDePastel"></canvas>
                             <script>
            // Obtener el elemento canvas y crear el gráfico
             var ctx = document.getElementById('miGraficoDePastel').getContext('2d');
    
            var data = {
                labels: ['Pendiente', 'Terminado', 'en proceso'],
                datasets: [{
                    data: [30, 40, 30], // Los valores para cada segmento del pastel
                    backgroundColor: ['red', 'blue', 'green'], // Colores de los segmentos
                }]
            };
            var opciones = {
                // Configuraciones opcionales, como leyendas, título, etc.
                responsive: true,
